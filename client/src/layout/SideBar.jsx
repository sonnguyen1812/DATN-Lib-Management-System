...
const SideBar = ({ isSideBarOpen, setIsSideBarOpen, setSelectedComponent }) => {
  ...
  return (
    <>
      <aside
        className={`${isSideBarOpen ? "left-0" : "-left-full"} z-10 transition-all duration-700 md:relative md:left-0 flex
         w-64 bg-black text-white flex-col h-full`}
        style={{ position: "fixed" }}
      >
        <div className="px-6 py-4 my-8 ">
          <img src={logo_with_title} alt="Logo With Title" />
        </div>
        ...
        <img
          ...
          className="h-fit w-fit absolute top-0 right-4 mt-4
          block md:hidden"
        />
      </aside>
    </>
